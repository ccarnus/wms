      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="flex flex-col rounded-2xl border-2 border-brand-600 bg-white p-8 shadow-xl shadow-brand-600/10 sm:p-10">
            ...
            <a
              href="#demo"
              className="mt-10 block w-full cursor-pointer rounded-xl bg-brand-600 px-8 py-3.5 text-center text-base font-semibold text-white shadow-lg shadow-brand-600/20 transition-colors duration-200 hover:bg-brand-700"
            >
              Get Started
            </a>

            <div className="mt-5 flex items-center justify-center gap-4 text-xs text-slate-400">
              <span className="flex items-center gap-1.5">{TRUST_ICON} No commitment</span>
              <span className="flex items-center gap-1.5">{TRUST_ICON} Cancel anytime</span>
              <span className="flex items-center gap-1.5">{TRUST_ICON} Live in 1 week</span>
            </div>
          </div>
          ...
          <div className="flex flex-col rounded-2xl border-2 border-slate-900 bg-slate-900 p-8 shadow-xl shadow-slate-900/20 sm:p-10">
            ...
            <a
              href="#demo"
              className="mt-10 block w-full cursor-pointer rounded-xl bg-white px-8 py-3.5 text-center text-base font-semibold text-slate-900 shadow-lg transition-colors duration-200 hover:bg-slate-100"
            >
              Talk to Sales
            </a>
        ...
        <div className="mx-auto mt-10 max-w-5xl rounded-2xl border border-slate-200 bg-slate-50 px-8 py-6">
